...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Anotação Pcastro',
        items: [
          
          {
            href: 'https://github.com/pcastroneto',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Caderno Virtual, Inc. Built with Docusaurus.`,
      },
      prism: {
